...
diffuser = Diffusion(scheduler=LinearScheduler(T=1000))
images = diffuser.get_backward_process_list(T=1000, batch_size=2, model_path="checkpoint_linear")
visualize_process(images, n_rows=2, n_cols=20)